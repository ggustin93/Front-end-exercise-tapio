    ...
    return (
      <article className="md:p-10 p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
        <div class="flex justify-end p-1">
          <Link to={`/edit/${id}`}>
            <button class="px-2 py-2 bg-primary-500 hover:bg-primary-600 text-white text-sm font-medium p-1 mr-1 rounded-md hover:animate-bounce">
              <svg
          ...
          <Link onClick={this.confirmDeletion}>
            <button class="px-2 py-2 bg-red-600 hover:bg-red-700 text-white text-sm font-medium rounded-md ml-1">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-5 w-6"
                fill="none"
        ...
        <div class="flex h-44 round-xl mt-6 mb-5 p-1">
          <div
            class="rounded-md"
            style={{
              flex: `1 1 0%`,
        ...
        <div class="flex justify-between items-center">
          <div class="flex items-center space-x-4">
            ...
            <span class="font-medium dark:text-white">JSON Doe {userId}</span>
          </div>
          <Link
            to={`/post/${id}`}
            href="#"
            class="inline-flex items-center font-medium text-gray-900 dark:text-primary-900 hover:underline"
          >
            Read more
            <svg
              class="ml-2 w-4 h-4"
